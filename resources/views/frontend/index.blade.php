      ...
      <div class="row">
          ...
          <div class="row tn-slider">
            ...
            <div class="col-md-6">
              <div class="tn-img">
                ...
                <div class="tn-title">
                  <a href="{{ route ('frontend.show.post',$post->slug) }}">{{$post->title}}</a>
                </div>
              </div>
            </div>
            @endforeach
        ...
        <div class="col-md-6 tn-right">
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="tn-img">
                <img src="{{asset($post->images->first()->path)}}" width="210px" height="200px"/>
                <div class="tn-title">
                  <a href="{{ route ('frontend.show.post',$post->slug) }}">{{$post->title}}</a>
                </div>
              </div>
      ...
      <div class="row">
          ...
          <div class="tab-content">
            ...
            <div id="popular" class="container tab-pane fade">
              ...
              <div class="tn-news">
                ...
                <div class="tn-title">
                  <a href="{{ route ('frontend.show.post',$post->slug) }}">{{$post->title}}comments ({{$post->comments_count}})</a>
                </div>
              </div>
              @endforeach
        ...
        <div class="col-md-6">
          ...
          <div class="tab-content">
            ...
            <div class="tn-news">
              <div class="tn-img">
                <img src="{{asset($post->images->first()->path)}}" width="150px" height="113px"/>
              </div>
              <div class="tn-title">
                <a href="{{ route ('frontend.show.post',$post->slug) }}">{{$post->title}}</a>
              </div>
            ...
            <div id="m-read" class="container tab-pane fade">
              ...
              <div class="tn-news">
                ...
                <div class="tn-title">
                  <a href="{{ route ('frontend.show.post',$post->slug) }}">{{$post->title}}({{$post->num_of_views}})</a>
                </div>
              </div>
              @endforeach
      ...
      <div class="row">
        <div class="col-lg-9">
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="mn-img">
                <img src="{{asset($post->images->first()->path)}}" width="210px" height="157.5px"/>
                <div class="mn-title">
                  <a href="{{ route ('frontend.show.post',$post->slug) }}">{{$post->title}}</a>
                </div>
              </div>
        ...
        <div class="col-lg-3">
          <div class="mn-list">
            ...
            <ul>
              ...
              <li><a href="{{ route ('frontend.show.post',$post->slug) }}">{{$post->title}}</a></li>
              @endforeach
            </ul>
          </div>
        </div>

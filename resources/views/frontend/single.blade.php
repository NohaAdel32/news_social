      ...
      <div class="row">
        <div class="col-lg-8">
            ...
            <div class="comment-section">
              ...
              <div class="comments">
                <div class="comment">
                  <img src="{{asset('assets/frontend/./img/news-450x350-2.jpg')}}" alt="User Image" class="comment-img" />
            ...
            <div class="sn-related">
              ...
              <div class="row sn-slider">
                <div class="col-md-4">
                  <div class="sn-img">
                    <img src="{{asset('assets/frontend/img/news-350x223-1.jpg')}}" class="img-fluid" alt="Related News 1" />
                    <div class="sn-title">
                ...
                <div class="col-md-4">
                  <div class="sn-img">
                    <img src="{{asset('assets/frontend/img/news-350x223-2.jpg')}}" class="img-fluid" alt="Related News 2" />
                    <div class="sn-title">
                      <a href="#">Interdum et fames ac ante</a>
                    </div>
                  </div>
                ...
                <div class="col-md-4">
                  <div class="sn-img">
                    <img src="{{asset('assets/frontend/img/news-350x223-3.jpg')}}" class="img-fluid" alt="Related News 3" />
                    <div class="sn-title">
                      <a href="#">Interdum et fames ac ante</a>
                    </div>
                  </div>
                ...
                <div class="col-md-4">
                  <div class="sn-img">
                    <img src="{{asset('assets/frontend/img/news-350x223-4.jpg')}}" class="img-fluid" alt="Related News 4" />
                    <div class="sn-title">
                      <a href="#">Interdum et fames ac ante</a>
                    </div>
                  </div>
